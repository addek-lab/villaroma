...
const navLinks = [
    ...
    { href: "/aromakueche", label: "Aromaküche" },
...
export function Navbar() {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-forest/5">
            <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-20">
                    {/* Logo */}
                    <Link href="/" className="flex items-center gap-3 no-underline">
                        <Image src={logoImage} alt="Villaroma — Maria M. Kettenring" priority className="h-14 sm:h-20 w-auto mix-blend-multiply" />
                    </Link>
